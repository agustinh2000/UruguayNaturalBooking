...
namespace RepositoryException
{
    public class MessagesExceptionRepository
    {
        ...
        public static string ErrorGettingScoreAverageReview = "Error. Ha ocurrido un error al tratar de obtener el promedio de las reviews para el hospedaje dado.";
        public static string ErrorGettingReviewByReserveId = "Error. Ha ocurrido un error al tratar de obtener la review por el codigo de reserva dado.";
